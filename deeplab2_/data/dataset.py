...
_EMID_AVI = 'emid_avi'
_EMID_4CLASSES = 'emid_4classes'
_EMID_DAY_AVI = 'emid_day_avi'
...
EMID_AVI_INFORMATION = DatasetDescriptor(
    dataset_name=_EMID_AVI,
    splits_to_sizes={'Vis': 7,
                     'Real_test1_SuperSaneado': 8271,
                     'Train1_1x2': 2242,
                     'Test1_1x2': 749,
                     'Test1_EMI': 250,
                     'Train1_EMI': 750
    ...
    ignore_label=255,
    panoptic_label_divisor=1000,
    class_has_instances_list=tuple(),  #tuple(range(0, 2)),
    is_video_dataset=False,
    colormap=_EMID_COLORMAP,
    is_depth_dataset=False,
    ignore_depth=None,
)

EMID_4CLASSES_INFORMATION = DatasetDescriptor(
    dataset_name=_EMID_AVI,
    splits_to_sizes={'test': 374,
                     'train': 1456,
                     'sunny': 7143,
                     'cloudy': 7147,
                     'v2opacityaviles': 2137,
                     },
...
_EMID_DAY_AVI_INFORMATION = DatasetDescriptor(
    dataset_name=_EMID_DAY_AVI,
    splits_to_sizes={'test': 324,
                     'train': 970,
                     },
...
MAP_NAME_TO_DATASET_INFO = {
    ...
    _EMID_AVI: EMID_AVI_INFORMATION,
    _EMID_4CLASSES: EMID_4CLASSES_INFORMATION,
    _EMID_DAY_AVI: _EMID_DAY_AVI_INFORMATION,
}
