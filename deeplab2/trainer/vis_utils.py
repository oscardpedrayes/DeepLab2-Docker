...
def create_emid_label_colormap():
  """Creates a label colormap for emid.

  Returns:
    A colormap for visualizing segmentation results.
  """
  colormap = np.zeros((256, 3), dtype=np.uint8)
  colormap[0] = [250, 150, 70] #CH - LIGHTORANGE
  colormap[1] = [135, 200, 235] #SK/CL - LIGHTBLUE
  colormap[2] =  [70, 200, 100] #LE - LIGHTGREEN
  colormap[3] = [0, 0, 0] #OT/BU - BLACK
  colormap[4] = [255, 255, 255] #IGNORE_LABEL - WHITE
  return colormap
...
def label_to_color_image(label, colormap_name='cityscapes'):
  ...
  elif colormap_name == 'emid_color':
    colormap = create_emid_label_colormap()
  else:
